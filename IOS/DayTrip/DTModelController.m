...
@interface DTModelController()
@property (readonly, strong, nonatomic) NSArray *pageData;
@end

@implementation DTModelController
...
{   
    ...
    DTDataViewController *dataViewController = [storyboard instantiateViewControllerWithIdentifier:@"DTDataViewController"];
...
{
    NSUInteger index = [self indexOfViewController:(DTDataViewController *)viewController];
